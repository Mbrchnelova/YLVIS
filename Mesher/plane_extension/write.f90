     ...
     write(write_unit, "(A)") "ENDOFSECTION"
      ...
      write(write_unit, "(A32, 8I10)") "y0", 1, n1, 0, 6
      ...
      write(write_unit, "(A32, 8I10)") "x1", 1, n2, 0, 6
      ...
      write(write_unit, "(A32, 8I10)") "y1", 1, n3, 0, 6
      ...
      write(write_unit, "(A32, 8I10)") "x0", 1, n4, 0, 6
      ...
      do i = 1, nelem
         ...
         write(write_unit, "(I8,1X,I2,1X,I2,1X,6I8)") &
      ...
      write(write_unit, "(A32, 8I10)") "z0", 1, n1, 0, 6
      ...
      write(write_unit, "(A32, 8I10)") "z1", 1, n3, 0, 6
      ...
      write(write_unit, "(A32, 8I10)") "y0", 1, n5, 0, 6
      ...
      write(write_unit, "(A32, 8I10)") "y1", 1, n6, 0, 6
